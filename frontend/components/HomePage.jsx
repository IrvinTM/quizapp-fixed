...
export default function HomePage() {
  ...
  <div className="bg-[oklch(0.141_0.005_285.823)] w-full flex space-x items-center justify-center">
    ...
    <Card.Text className="text-md text-white ml-1 mb-5">
        ...
        <a  className="  text-blue-500 items-center justify-center mt-2 mb-20 rounded-2xl text-2xl py-2 px-4 transition-colors duration-500 border-black bg-gray-900 hover:border-1 hover:border-blue-500 cursor-pointer">Go Requests</a>      </Card.Body>
        <Card.Footer className='mb-2 mt-5'>    
            <small className="text-muted ml-2">Last updated 3 mins ago</small>
          </Card.Footer>
        </Card>
