    ...
    Text Color:oklch(0.359_0.144_278.697) */}
      ...
      <div className="flex items-center justify-center h-50 bg-[oklch(0.141_0.005_285.823)]">
        <div className="flex items-center justify-center bg-black-100 p-3 rounded-lg hover:text-blue-500">
          <a href="/Quiz" className="flex w-42 py-2 px-2 items-center justify-center border-double text-xl text-white border-5 rounded-lg border-blue-500">Take ACE Quiz</a>
        </div>
      </div>
  ...
  <div className="bg-[oklch(0.141_0.005_285.823)] w-full flex space-x items-center justify-center">
    ...
    <Card style={{ width: '18rem' }} className='mr-20'>
      ...
      <Card.Body>
        ...
        <a href="/Analytics" variant="dark" className="ml-16 text-blue-500 items-center justify-center mt-2 mb-20 border-2 border-black rounded-2xl text-2xl py-2 px-2 bg-gray-900 ">Go Analytics</a>
      </Card.Body>
    ...
    <Card.Text className="text-md text-white ml-1 mb-5">
        ...
        <a href="/Questions" variant="dark" className="ml-16 text-blue-500 items-center justify-center mt-2 mb-20 border-2 border-black rounded-2xl text-2xl py-2 px-2 bg-gray-900 ">Go Questions</a>
      </Card.Body>
